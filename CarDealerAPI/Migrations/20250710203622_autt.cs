        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    condicionName = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 2019, "Toyota Corolla usado, excelente estado, único dueño.", true, 1, 1, 1, 1, "Toyota", "1.8L 4 cilindros", 35000.0, new DateTime(2023, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) });
